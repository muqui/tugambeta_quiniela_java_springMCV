    ...
    <tiles:insertDefinition name="defaultTemplate">
        ...
        <div class="">
            ...
            <c:if test="${(dos >= 1)  || (tres >= 1)}">
                <div class="container">
                    <form:form method="POST" action="${jugar}" modelAttribute="jugador" id="registerform" class="form-signin"  onsubmit="return validarFormulario()">

                        </br>
                        <form:input  id="jugador" path="jugador" placeholder="Nombre" class="form-control"  />
                        </br>
                        ...
                        <table id="tableJugar"  >  
                          ...
                          <div class="row">
                            <div class="col-lg-4 col-lg-offset-4" >
                                      ...
                                      <input  type="submit"  class="form-control btn btn-primary btn-block btn-signin " value="Enviar"/>
