...
<div class="logomenu">
             ...
             <li><a href="/admingrupo/crearquiniela">Crear quiniela</a></li>
            <li><a href="/admingrupo/resultados">Actualizar resultados</a></li>
            <li><a href="/admingrupo/eliminarparticipante">Eliminar participante </a></li>
               <li><a href="/admingrupo/quinielas">Editar Quiniela </a></li>
                
            <li><a href="/admingrupo">home </a></li>
